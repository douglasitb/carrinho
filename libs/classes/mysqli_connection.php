...
class MySQLiConnection extends mysqli
{
	...
	/*
	   Funчуo __construct()
	   Realiza automaticamene a conexуo com o banco de dados ao instanciar o objeto com o opeador new ($my = new MySQLiConnection()).
	*/
	...
	/*
	   Funчуo __destruct()
	   Caso haja uma conexуo com o banco de dados, fecha-a automaticamente ao terminar de executar o script.
	*/
