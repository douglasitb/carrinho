...
$constantes = array("DB_SERVIDOR" => "localhost", "DB_USUARIO" => "root", "DB_SENHA" => "12345678", "DB_NOME" => "produto_teste",  "IMAGENS_PATH" => "img" . BARRA, "CSS_PATH" => "css" . BARRA, "CSS_ARQ" => "default.css", "JS_PATH" => "js" . BARRA, "JS_ARQ" => "default.js", "FUNCOES_PATH" => "libs" . BARRA, "FUNCOES_ARQ" => "funcoes.php", "CLASSES_PATH" => "libs" . BARRA, "CLASSES_ARQ" => "classes.php", "LOGS_PATH" => "logs"  . BARRA);
